...
public class Weapon : MonoBehaviour
{
    ...
    public float nextShotTime; // time the will fire next
    ...
    void Start()
    {
        ...
        //Call SetType() for the defualt _type set in the Inspector
        SetType(_type);
    ...
    public void SetType(eWeaponType wt)
    {
        ...
        //Get the WeaponDefinition fort his type from Main
