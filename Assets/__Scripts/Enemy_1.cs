...
public class Enemy_1 : Enemy    //Enemy_1 also extends the Enemy class
{
    ...
    void Start()
    {
        //set x0 to the initial x position Enemy_1
        x0 = pos.x;
        birthTime = Time.time;
    }
    ...
    {
        //Because os is a property, you can't directly set pos.x
        // so get the pos as editable Vector3
        Vector3 tempPos = pos;
        ...
        //base.Move()still handles the movment down in y
        base.Move();
        // print(bndCheck.isOnScreen); //Leave this line commented outasd
