...
public class Enemy_3 : Enemy // Enemy 3 also extends the Enemy class
{
    ...
    //again, Start works well because it is not used in the Enmy superclas
    // Start is called before the first frame update
    void Start()
    {
        points = new Vector3[3]; //Initialize points
        //The start position has already beern set by Main.SpawnEnemy()
        points[0] = pos;
        ...
        //pick a random final poistion above the toop of the screen
    ...
    {
        //Bezier curves work based on a u value betwee 0 & 1
