...
{
    /// <summary>
    /// While most Bezier curves are 3 or 4 points, it is possible to have any
    /// number of points using this recursive function
    /// </summary>
    ...
    static public Vector3 Bezier(float u, params Vector3[] points)
    {
        ...
        {
            vArr[r, c] = points[c];
            //vList here idk whyyyy but switched it to points
