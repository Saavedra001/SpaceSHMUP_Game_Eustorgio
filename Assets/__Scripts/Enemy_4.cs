...
public class Enemy_4 : Enemy
{
    ...
    void Start()
    {
        ...
        //Initially set p0 & p1 to the current position (fromMain.Spawn())
        p0 = p1 = pos;
        InitMovement();
    }
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        if(p != null)
        {
            //Destroy the Projectile Hero regardless of bndCheck.isOnScreen
            Destroy(otherGO);
            ...
            if (bndCheck.isOnScreen)
            {
                ...
                //ifthisShield is still active then it has not been destroyed
